...
var Ua = {
    ...
    bio_pattern: Ie,
    bio_supporter: Oe,
    female_first_name: qe,
    female_middle_name: je,
    female_prefix: e,
    first_name: Ve,
    gender: Ye,
    job_title_pattern: Ue,
    last_name: _e,
    last_name_pattern: Ze,
    male_first_name: Qe,
    male_middle_name: Xe,
    male_prefix: a,
    middle_name: $e,
...
"[project]/unexpected/node_modules/@faker-js/faker/dist/esm/chunk-GTEBSQTL.mjs [app-rsc] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
var Xr = (i, e)=>{
    for(var r in e)Ce(i, r, {
        get: e[r],
        enumerable: !0
    });
};
var f = (i, e, r)=>(hr(i, typeof e != "symbol" ? e + "" : e, r), r);
...
var Me = ((t)=>(t.Narrowbody = "narrowbody", t.Regional = "regional", t.Widebody = "widebody", t))(Me || {}), fr = [
    "0",
    "1",
    "2",
    "3",
    ...
    recordLocator(e = {}) {
        ...
        return r || a.push(...fr), t || a.push(...br), this.faker.string.alphanumeric({
            length: 6,
            casing: "upper",
            exclude: a
        });
    ...
    seat(e = {}) {
        let { aircraftType: r = "narrowbody" } = e, t = dr[r], a = gr[r], n = this.faker.number.int({
            min: 1,
            max: t
        }), s = this.faker.helpers.arrayElement(a);
        return `${n}${s}`;
    }
    aircraftType() {
...
function kr(i, e = "rgb", r = "sRGB") {
    let t = (a)=>Math.round(a * 100);
    switch(e){
        case "rgba":
        ...
        case "cmyk":
            return `cmyk(${t(i[0])}%, ${t(i[1])}%, ${t(i[2])}%, ${t(i[3])}%)`;
        case "hsl":
            return `hsl(${i[0]}deg ${t(i[1])}% ${t(i[2])}%)`;
        case "hsla":
            return `hsl(${i[0]}deg ${t(i[1])}% ${t(i[2])}% / ${t(i[3])})`;
        case "hwb":
            return `hwb(${i[0]} ${t(i[1])}% ${t(i[2])}%)`;
        case "lab":
            return `lab(${t(i[0])}% ${i[1]} ${i[2]})`;
        case "lch":
            return `lch(${t(i[0])}% ${i[1]} ${i[2]})`;
        case "rgb":
        default:
            return `rgb(${i[0]}, ${i[1]}, ${i[2]})`;
    }
}
function R(i, e, r = "rgb", t = "sRGB") {
    switch(e){
        case "css":
            return kr(i, r, t);
        case "binary":
...
var G = class extends b {
    ...
    rgb(e = {}) {
        let { format: r = "hex", includeAlpha: t = !1, prefix: a = "#", casing: n = "lower" } = e, s, o = "rgb";
        return r === "hex" ? (s = this.faker.string.hexadecimal({
            length: t ? 8 : 6,
            prefix: ""
        }), s = yr(s, {
            prefix: a,
            ...
            length: 3
        }, ()=>this.faker.number.int(255)), t && (s.push(this.faker.number.float({
            multipleOf: .01
        })), o = "rgba"), R(s, r, o));
    }
    cmyk(e) {
        ...
        return R(r, (e == null ? void 0 : e.format) || "decimal", "cmyk");
    }
    hsl(e) {
        let r = [
            this.faker.number.int(360)
        ];
        for(let t = 0; t < (e != null && e.includeAlpha ? 3 : 2); t++)r.push(this.faker.number.float({
            multipleOf: .01
        }));
        return R(r, (e == null ? void 0 : e.format) || "decimal", e != null && e.includeAlpha ? "hsla" : "hsl");
    }
    hwb(e) {
        let r = [
            this.faker.number.int(360)
        ];
        for(let t = 0; t < 2; t++)r.push(this.faker.number.float({
            multipleOf: .01
        }));
        return R(r, (e == null ? void 0 : e.format) || "decimal", "hwb");
    }
    lab(e) {
        let r = [
            this.faker.number.float({
        ...
        return R(r, (e == null ? void 0 : e.format) || "decimal", "lab");
    }
    lch(e) {
        let r = [
            this.faker.number.float({
        ...
        return R(r, (e == null ? void 0 : e.format) || "decimal", "lch");
    }
    colorByCSSColorSpace(e) {
        (e == null ? void 0 : e.format) === "css" && !(e != null && e.space) && (e = {
            ...e,
            space: "sRGB"
        });
        let r = Array.from({
        ...
        return R(r, (e == null ? void 0 : e.format) || "decimal", "color", e == null ? void 0 : e.space);
    }
};
var U = ()=>{
...
function Le(i) {
    ...
    return new Proxy(i, {
        ...
        get (r, t) {
            return typeof t == "symbol" || t === "nodeType" ? r[t] : t in e ? e[t] : e[t] = xr(t, r[t]);
        },
        set: U,
        deleteProperty: U
    });
...
var Pe = ((r)=>(r.Female = "female", r.Male = "male", r))(Pe || {});
function P(i, e, r, { generic: t, female: a, male: n }, s) {
    let o;
    switch(r){
        case "female":
            o = a;
    ...
    return o == null && (a != null && n != null ? o = i.helpers.arrayElement([
        a,
        n
    ]) : o = t, v(o, `person.{${s}, female_${s}, male_${s}}`)), e(o);
}
var O = class extends b {
    firstName(e) {
        var n;
        let { first_name: r, female_first_name: t, male_first_name: a } = (n = this.faker.rawDefinitions.person) != null ? n : {};
        return P(this.faker, this.faker.helpers.arrayElement, e, {
            generic: r,
            female: t,
            male: a
        }, "first_name");
    ...
    lastName(e) {
        var l;
        let { last_name: r, female_last_name: t, male_last_name: a, last_name_pattern: n, male_last_name_pattern: s, female_last_name_pattern: o } = (l = this.faker.rawDefinitions.person) != null ? l : {};
        if (n != null || s != null || o != null) {
            let c = P(this.faker, this.faker.helpers.weightedArrayElement, e, {
                generic: n,
                female: o,
                male: s
            }, "last_name_pattern");
            return this.faker.helpers.fake(c);
        }
        return P(this.faker, this.faker.helpers.arrayElement, e, {
            generic: r,
            female: t,
    ...
    middleName(e) {
        var n;
        let { middle_name: r, female_middle_name: t, male_middle_name: a } = (n = this.faker.rawDefinitions.person) != null ? n : {};
        return P(this.faker, this.faker.helpers.arrayElement, e, {
            generic: r,
            female: t,
            male: a
    ...
    sexType() {
        return this.faker.helpers.enumValue(Pe);
    }
    bio() {
    ...
    prefix(e) {
        var n;
        let { prefix: r, female_prefix: t, male_prefix: a } = (n = this.faker.rawDefinitions.person) != null ? n : {};
        return P(this.faker, this.faker.helpers.arrayElement, e, {
            generic: r,
            female: t,
            male: a
    ...
    jobDescriptor() {
        let e = this.faker.definitions.person.title.descriptor;
        if (e == null) throw new u("No person.title.descriptor definitions available.");
        return this.faker.helpers.arrayElement(e);
    }
    jobArea() {
        let e = this.faker.definitions.person.title.level;
        if (e == null) throw new u("No person.title.area definitions available.");
        return this.faker.helpers.arrayElement(e);
    }
    jobType() {
        let e = this.faker.definitions.person.title.job;
        if (e == null) throw new u("No person.title.job definitions available.");
        return this.faker.helpers.arrayElement(e);
    }
    zodiacSign() {
...
var xe = class {
    constructor(){
        f(this, "N", 624);
        f(this, "M", 397);
        f(this, "MATRIX_A", 2567483615);
        f(this, "UPPER_MASK", 2147483648);
        f(this, "LOWER_MASK", 2147483647);
        f(this, "mt", Array.from({
            length: this.N
        }));
        f(this, "mti", this.N + 1);
        f(this, "mag01", [
    ...
    subtraction32(e, r) {
        return e < r ? this.unsigned32(4294967296 - (r - e) & 4294967295) : e - r;
    }
    addition32(e, r) {
        return this.unsigned32(e + r & 4294967295);
    }
    multiplication32(e, r) {
        let t = 0;
        for(let a = 0; a < 32; ++a)e >>> a & 1 && (t = this.addition32(t, this.unsigned32(r << a)));
        return t;
    }
    initGenrand(e) {
    ...
    initByArray(e, r) {
        ...
        let t = 1, a = 0, n = this.N > r ? this.N : r;
        for(; n; n--)this.mt[t] = this.addition32(this.addition32(this.unsigned32(this.mt[t] ^ this.multiplication32(this.unsigned32(this.mt[t - 1] ^ this.mt[t - 1] >>> 30), 1664525)), e[a]), a), this.mt[t] = this.unsigned32(this.mt[t] & 4294967295), t++, a++, t >= this.N && (this.mt[0] = this.mt[this.N - 1], t = 1), a >= r && (a = 0);
        for(n = this.N - 1; n; n--)this.mt[t] = this.subtraction32(this.unsigned32(this.mt[t] ^ this.multiplication32(this.unsigned32(this.mt[t - 1] ^ this.mt[t - 1] >>> 30), 1566083941)), t), this.mt[t] = this.unsigned32(this.mt[t] & 4294967295), t++, t >= this.N && (this.mt[0] = this.mt[this.N - 1], t = 1);
    ...
    genrandInt32() {
        ...
        if (this.mti >= this.N) {
            let r;
            for(this.mti === this.N + 1 && this.initGenrand(5489), r = 0; r < this.N - this.M; r++)e = this.unsigned32(this.mt[r] & this.UPPER_MASK | this.mt[r + 1] & this.LOWER_MASK), this.mt[r] = this.unsigned32(this.mt[r + this.M] ^ e >>> 1 ^ this.mag01[e & 1]);
            for(; r < this.N - 1; r++)e = this.unsigned32(this.mt[r] & this.UPPER_MASK | this.mt[r + 1] & this.LOWER_MASK), this.mt[r] = this.unsigned32(this.mt[r + (this.M - this.N)] ^ e >>> 1 ^ this.mag01[e & 1]);
    ...
    genrandRes53() {
        let e = this.genrandInt32() >>> 5, r = this.genrandInt32() >>> 6;
        return (e * 67108864 + r) * (1 / 9007199254740992);
    }
};
function $e() {
    let i = new xe;
...
var K = class extends E {
    number(e = 99999) {
        ...
        let { min: r = 0, max: t = r + 99999, precision: a = 1 } = e;
    ...
    float(e = {}) {
        ...
        let { min: r = 0, max: t = r + 99999, precision: a = .01 } = e;
        return this.faker.number.float({
            min: r,
            max: t,
            multipleOf: a
    ...
    datetime(e = {}) {
        ...
        let r = 864e13, t = typeof e == "number" ? void 0 : e.min, a = typeof e == "number" ? e : e.max;
        return (t == null || t < r * -1) && (t = Date.UTC(1990, 0)), (a == null || a > r) && (a = Date.UTC(2100, 0)), this.faker.date.between({
            from: t,
            to: a
        });
    }
    ...
    json() {
        ...
        for (let t of e)r[t] = this.boolean() ? this.faker.string.sample() : this.faker.number.int();
    ...
    array(e = 10) {
        return m({
            ...
            since: "8.0",
            until: "9.0"
        }), this.faker.helpers.multiple(()=>this.boolean() ? this.faker.string.sample() : this.faker.number.int(), {
            count: e
        });
    }
    bigInt(e) {
...
function D(i, e) {
    return i == null ? e() : (i = new Date(i), Number.isNaN(i.valueOf()) && (i = e()), i);
}
var $ = class extends E {
    anytime(e = {}) {
        let { refDate: r } = e, t = D(r, this.faker.defaultRefDate);
        return this.between({
            from: new Date(t.getTime() - 1e3 * 60 * 60 * 24 * 365),
            to: new Date(t.getTime() + 1e3 * 60 * 60 * 24 * 365)
        });
    }
    past(e = {}, r) {
        typeof e == "number" && (m({
        ...
        let { years: t = 1, refDate: a = r } = e;
        if (t <= 0) throw new u("Years must be greater than 0.");
        let n = D(a, this.faker.defaultRefDate), s = {
            min: 1e3,
            max: t * 365 * 24 * 3600 * 1e3
        }, o = n.getTime();
        return o -= this.faker.number.int(s), n.setTime(o), n;
    }
    future(e = {}, r) {
        typeof e == "number" && (m({
    ...
    between(e, r) {
        (e instanceof Date || typeof e != "object") && (m({
        ...
        let { from: t, to: a } = e, n = D(t, this.faker.defaultRefDate).getTime(), s = D(a, this.faker.defaultRefDate).getTime(), o = this.faker.number.int(s - n);
        return new Date(n + o);
    }
    betweens(e, r, t = 3) {
        (e instanceof Date || typeof e != "object") && (m({
        ...
        let { from: a, to: n, count: s = 3 } = e;
        return this.faker.helpers.multiple(()=>this.between({
                from: a,
                to: n
            }), {
            count: s
        }).sort((o, l)=>o.getTime() - l.getTime());
    }
    recent(e = {}, r) {
        typeof e == "number" && (m({
    ...
    birthdate(e = {}) {
        var o, l, c, p;
        let r = e.mode === "age" ? "age" : "year", t = D(e.refDate, this.faker.defaultRefDate), a = t.getUTCFullYear(), n, s;
        if (r === "age" ? (n = new Date(t).setUTCFullYear(a - ((o = e.max) != null ? o : 80) - 1), s = new Date(t).setUTCFullYear(a - ((l = e.min) != null ? l : 18))) : (n = new Date(Date.UTC(0, 0, 2)).setUTCFullYear((c = e.min) != null ? c : a - 80), s = new Date(Date.UTC(0, 11, 30)).setUTCFullYear((p = e.max) != null ? p : a - 19)), s < n) throw new u(`Max ${e.max} should be larger than or equal to min ${e.min}.`);
    ...
    month(r = {}) {
        let { abbr: t, abbreviated: a = t != null ? t : !1, context: n = !1 } = r;
        t != null && m({
        ...
        let s = this.faker.definitions.date.month, o;
        a ? o = n && s.abbr_context != null ? "abbr_context" : "abbr" : o = n && s.wide_context != null ? "wide_context" : "wide";
        let l = s[o];
        return v(l, "date.month", o), this.faker.helpers.arrayElement(l);
    }
    weekday(r = {}) {
        let { abbr: t, abbreviated: a = t != null ? t : !1, context: n = !1 } = r;
        t != null && m({
        ...
        let s = this.faker.definitions.date.weekday, o;
        a ? o = n && s.abbr_context != null ? "abbr_context" : "abbr" : o = n && s.wide_context != null ? "wide_context" : "wide";
        let l = s[o];
        return v(l, "date.weekday", o), this.faker.helpers.arrayElement(l);
    }
};
var Ar = /\.|\(/;
function Be(i, e, r = [
    ...
    if (r.length === 0) throw new u("Eval entrypoints cannot be empty.");
    let t = r, a = i;
    do {
        let s;
        a.startsWith("(") ? [s, t] = wr(a, t) : [s, t] = Sr(a, t), a = a.substring(s), t = t.filter((o)=>o != null).map((o)=>Array.isArray(o) ? e.helpers.arrayElement(o) : o);
    }while (a.length > 0 && t.length > 0)
    if (t.length === 0) throw new u(`Cannot resolve expression '${i}'`);
    let n = t[0];
    return typeof n == "function" ? n() : n;
}
function wr(i, e) {
    let [r, t] = Er(i), a = i[r + 1];
    switch(a){
        case ".":
        case "(":
        case void 0:
    ...
    return [
        r + (a === "." ? 2 : 1),
        e.map((n)=>typeof n == "function" ? n(...t) : n)
    ];
}
function Er(i) {
    let e = i.indexOf(")", 1);
...
function Sr(i, e) {
    var o, l;
    let r = Ar.exec(i), t = ((o = r == null ? void 0 : r[0]) != null ? o : "") === ".", a = (l = r == null ? void 0 : r.index) != null ? l : i.length, n = i.substring(0, a);
    if (n.length === 0) throw new u(`Expression parts cannot be empty in '${i}'`);
    let s = i[a + 1];
    if (t && (s == null || s === "." || s === "(")) throw new u(`Found dot without property name in '${i}'`);
    return [
        a + (t ? 1 : 0),
        e.map((c)=>Tr(c, n))
    ];
...
function Nr(i, e) {
    return i[e] === void 0 ? -1 : 0;
}
function Ie(i, e, r, t, a) {
    throw console.error("Error", r), console.log(`Found ${Object.keys(t).length} unique entries before throwing error.
retried: ${a}
...
function Ae(i, e, r = {}) {
    let t = Date.now(), { startTime: a = Date.now(), maxTime: n = 50, maxRetries: s = 50, currentIterations: o = 0, compare: l = Nr, store: c = {} } = r, { exclude: p = [] } = r;
    if (r.currentIterations = o, Array.isArray(p) || (p = [
        p
    ]), t - a >= n) return Ie(a, t, `Exceeded maxTime: ${n}`, c, o);
    if (o >= s) return Ie(a, t, `Exceeded maxRetries: ${s}`, c, o);
    let h = i(...e);
    return l(c, h) === -1 && !p.includes(h) ? (c[h] = h, r.currentIterations = 0, h) : (r.currentIterations++, Ae(i, e, {
        ...r,
        startTime: a,
        maxTime: n,
        maxRetries: s,
...
function Ge(i, e = "") {
    let r = /(.)\{(\d+),(\d+)\}/, t = /(.)\{(\d+)\}/, a = /\[(\d+)-(\d+)\]/, n, s, o, l, c = r.exec(e);
    for(; c != null;)n = Number.parseInt(c[2]), s = Number.parseInt(c[3]), n > s && (o = s, s = n, n = o), l = i.number.int({
        min: n,
        max: s
    ...
    for(c = a.exec(e); c != null;)n = Number.parseInt(c[1]), s = Number.parseInt(c[2]), n > s && (o = s, s = n, n = o), e = e.slice(0, c.index) + i.number.int({
        min: n,
        max: s
...
var B = class extends E {
    ...
    slugify(r = "") {
        return r.normalize("NFKD").replace(/[\u0300-\u036F]/g, "").replace(/ /g, "-").replace(/[^\w.-]+/g, "");
    }
    replaceSymbolWithNumber(r = "", t = "#") {
        return m({
    ...
    replaceSymbols(r = "") {
        ...
        for(let n = 0; n < r.length; n++)r.charAt(n) === "#" ? a += this.faker.number.int(9) : r.charAt(n) === "?" ? a += this.arrayElement(t) : r.charAt(n) === "*" ? a += this.faker.datatype.boolean() ? this.arrayElement(t) : this.faker.number.int(9) : a += r.charAt(n);
        return a;
    }
    replaceCreditCardSymbols(r = "6453-####-####-####-###L", t = "#") {
        r = Ge(this.faker, r), r = z(this.faker, r, t);
        let a = Fe(r);
        return r.replace("L", String(a));
    }
    regexpStyleStringParse(r = "") {
        return m({
    ...
    fromRegExp(r) {
        var g, k, A, x, T, Se, Te;
        let t = !1;
        r instanceof RegExp && (t = r.flags.includes("i"), r = r.toString(), r = (k = (g = /\/(.+?)\//.exec(r)) == null ? void 0 : g[1]) != null ? k : "");
        let a, n, s, o = /([.A-Za-z0-9])(?:\{(\d+)(?:,(\d+)|)\}|(\?|\*|\+))(?![^[]*]|[^{]*})/, l = o.exec(r);
        for(; l != null;){
            let ge = l[2], ye = l[3], ke = l[4];
            s = _e(this.faker, ke, ge, ye), r = r.slice(0, l.index) + l[1].repeat(s) + r.slice(l.index + l[0].length), l = o.exec(r);
        }
        let c = /(\d-\d|\w-\w|\d|\w|[-!@#$&()`.+,/"])/, p = /\[(\^|)(-|)(.+?)\](?:\{(\d+)(?:,(\d+)|)\}|(\?|\*|\+)|)/;
        for(l = p.exec(r); l != null;){
            let ge = l[1] === "^", ye = l[2] === "-", ke = l[4], mr = l[5], ur = l[6], w = [], I = l[3], M = c.exec(I);
            for(ye && w.push(45); M != null;){
                if (M[0].includes("-")) {
                    let S = M[0].split("-").map((y)=>{
                        var L;
                        return (L = y.codePointAt(0)) != null ? L : Number.NaN;
                    });
                    if (a = S[0], n = S[1], a > n) throw new u("Character range provided is out of order.");
                    for(let y = a; y <= n; y++)if (t && Number.isNaN(Number(String.fromCodePoint(y)))) {
                        let L = String.fromCodePoint(y);
                        w.push((A = L.toUpperCase().codePointAt(0)) != null ? A : Number.NaN, (x = L.toLowerCase().codePointAt(0)) != null ? x : Number.NaN);
                    } else w.push(y);
                } else t && Number.isNaN(Number(M[0])) ? w.push((T = M[0].toUpperCase().codePointAt(0)) != null ? T : Number.NaN, (Se = M[0].toLowerCase().codePointAt(0)) != null ? Se : Number.NaN) : w.push((Te = M[0].codePointAt(0)) != null ? Te : Number.NaN);
                I = I.substring(M[0].length), M = c.exec(I);
            }
            if (s = _e(this.faker, ur, ke, mr), ge) {
                let S = -1;
                for(let y = 48; y <= 57; y++){
                    if (S = w.indexOf(y), S > -1) {
                        w.splice(S, 1);
                        continue;
                    }
                    w.push(y);
            ...
            let pr = this.multiple(()=>String.fromCodePoint(this.arrayElement(w)), {
                count: s
            }).join("");
            r = r.slice(0, l.index) + pr + r.slice(l.index + l[0].length), l = p.exec(r);
        }
        let h = /(.)\{(\d+),(\d+)\}/;
        for(l = h.exec(r); l != null;){
            if (a = Number.parseInt(l[2]), n = Number.parseInt(l[3]), a > n) throw new u("Numbers out of order in {} quantifier.");
            s = this.faker.number.int({
                min: a,
                max: n
            }), r = r.slice(0, l.index) + l[1].repeat(s) + r.slice(l.index + l[0].length), l = h.exec(r);
        }
        let d = /(.)\{(\d+)\}/;
        for(l = d.exec(r); l != null;)s = Number.parseInt(l[2]), r = r.slice(0, l.index) + l[1].repeat(s) + r.slice(l.index + l[0].length), l = d.exec(r);
        return r;
    }
    shuffle(r, t = {}) {
        let { inplace: a = !1 } = t;
    ...
    uniqueArray(r, t) {
        if (Array.isArray(r)) {
            ...
            return this.shuffle(s).splice(0, t);
        }
        let a = new Set;
        try {
            if (typeof r == "function") {
                let n = 1e3 * t, s = 0;
                for(; a.size < t && s < n;)a.add(r()), s++;
            }
        } catch  {}
        return [
            ...a
    ...
    mustache(r, t) {
        if (r == null) return "";
        for(let a in t){
            let n = new RegExp(`{{${a}}}`, "g"), s = t[a];
            typeof s == "string" && (s = s.replace(/\$/g, "$$$$")), r = r.replace(n, s);
        }
        return r;
    }
    maybe(r, t = {}) {
        if (this.faker.datatype.boolean(t)) return r();
    }
    objectKey(r) {
        let t = Object.keys(r);
    ...
    objectValue(r) {
        let t = this.faker.helpers.objectKey(r);
        return r[t];
    }
    objectEntry(r) {
        let t = this.faker.helpers.objectKey(r);
    ...
    arrayElement(r) {
        if (r == null) throw new u("Calling `faker.helpers.arrayElement()` without arguments is no longer supported.");
        if (r.length === 0) throw new u("Cannot get value from empty dataset.");
        let t = r.length > 1 ? this.faker.number.int({
            max: r.length - 1
        }) : 0;
        return r[t];
    }
    weightedArrayElement(r) {
        if (r.length === 0) throw new u("weightedArrayElement expects an array with at least one element");
        if (!r.every((s)=>s.weight > 0)) throw new u("weightedArrayElement expects an array of { weight, value } objects where weight is a positive number");
        let t = r.reduce((s, { weight: o })=>s + o, 0), a = this.faker.number.float({
            min: 0,
            max: t
        }), n = 0;
        for (let { weight: s, value: o } of r)if (n += s, a < n) return o;
        return r[r.length - 1].value;
    }
    arrayElements(r, t) {
        if (r == null) throw new u("Calling `faker.helpers.arrayElements()` without arguments is no longer supported.");
        if (r.length === 0) return [];
        let a = this.rangeToNumber(t != null ? t : {
            min: 1,
            max: r.length
        });
        if (a >= r.length) return this.shuffle(r);
        if (a <= 0) return [];
        let n = [
            ...r
        ], s = r.length, o = s - a, l, c;
        for(; s-- > o;)c = this.faker.number.int(s), l = n[c], n[c] = n[s], n[s] = l;
        return n.slice(o);
    }
    enumValue(r) {
        let t = Object.keys(r).filter((n)=>Number.isNaN(Number(n))), a = this.arrayElement(t);
        return r[a];
    }
    rangeToNumber(r) {
        return typeof r == "number" ? r : this.faker.number.int(r);
    }
    unique(r, t = [], a = {}) {
        m({
        ...
        let { maxTime: n = 50, maxRetries: s = 50, exclude: o = [], store: l = this.uniqueStore } = a;
        return Ae(r, t, {
            ...a,
            startTime: Date.now(),
            maxTime: n,
    ...
    multiple(r, t = {}) {
        var n;
        let a = this.rangeToNumber((n = t.count) != null ? n : 3);
        return a <= 0 ? [] : Array.from({
            length: a
        }, r);
    }
}, V = class extends B {
    ...
    fake(r) {
        ...
        if (t === -1 || a === -1) return r;
        let s = r.substring(t + 2, a + 2).replace("}}", "").replace("{{", ""), o = Be(s, this.faker), l = String(o), c = r.substring(0, t) + l + r.substring(a + 2);
        return this.fake(c);
    }
};
var H = class extends E {
    int(e = {}) {
        ...
        let { min: r = 0, max: t = Number.MAX_SAFE_INTEGER } = e, a = Math.ceil(r), n = Math.floor(t);
        if (a === n) return a;
        if (n < a) throw t >= r ? new u(`No integer value between ${r} and ${t} found.`) : new u(`Max ${t} should be greater than min ${r}.`);
        let o = this.faker._randomizer.next();
        return Math.floor(o * (n + 1 - a) + a);
    }
    float(e = {}) {
        typeof e == "number" && (e = {
            max: e
        });
        let { min: r = 0, max: t = 1, fractionDigits: a, precision: n, multipleOf: s = n, multipleOf: o = n != null ? n : a == null ? void 0 : 10 ** -a } = e;
        if (n != null && m({
        ...
        if (t < r) throw new u(`Max ${t} should be greater than min ${r}.`);
        if (a != null) {
            if (s != null) throw new u("multipleOf and fractionDigits cannot be set at the same time.");
            if (!Number.isInteger(a)) throw new u("fractionDigits should be an integer.");
            if (a < 0) throw new u("fractionDigits should be greater than or equal to 0.");
        }
        if (o != null) {
            if (o <= 0) throw new u("multipleOf/precision should be greater than 0.");
            let p = Math.log10(o), h = o < 1 && Number.isInteger(p) ? 10 ** -p : 1 / o;
            return this.int({
                min: r * h,
                max: t * h
            }) / h;
    ...
    bigInt(e = {}) {
        ...
        let r = BigInt((s = e.min) != null ? s : 0), t = BigInt((o = e.max) != null ? o : r + BigInt(999999999999999));
        if (t === r) return r;
        if (t < r) throw new u(`Max ${t} should be larger then min ${r}.`);
...
var W = [
    ...
    alpha(e = {}) {
        ...
        let r = this.faker.helpers.rangeToNumber((s = e.length) != null ? s : 1);
        if (r <= 0) return "";
    ...
    hexadecimal(e = {}) {
        var s;
        let { casing: r = "mixed", prefix: t = "0x" } = e, a = this.faker.helpers.rangeToNumber((s = e.length) != null ? s : 1);
        if (a <= 0) return t;
    ...
    numeric(e = {}) {
        ...
        let r = this.faker.helpers.rangeToNumber((o = e.length) != null ? o : 1);
        if (r <= 0) return "";
        let { allowLeadingZeros: t = !0 } = e, { exclude: a = [] } = e;
        typeof a == "string" && (a = [
            ...a
        ]);
        let n = Ue.filter((l)=>!a.includes(l));
        if (n.length === 0 || n.length === 1 && !t && n[0] === "0") throw new u("Unable to generate numeric string, because all possible digits are excluded.");
        let s = "";
        return !t && !a.includes("0") && (s += this.faker.helpers.arrayElement(n.filter((l)=>l !== "0"))), s += this.fromCharacters(n, r - s.length), s;
    }
    sample(e = 10) {
    ...
    uuid() {
        return "xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/x/g, ()=>this.faker.number.hex({
                min: 0,
                max: 15
            })).replace(/y/g, ()=>this.faker.number.hex({
                min: 8,
                max: 11
            }));
    }
...
var F = class {
    constructor(e = {}){
        f(this, "_defaultRefDate", ()=>new Date);
        f(this, "_randomizer");
        f(this, "datatype", new K(this));
        f(this, "date", new $(this));
        f(this, "helpers", new B(this));
        f(this, "number", new H(this));
        f(this, "string", new Z(this));
...
var Dr = {
    ...
    price(e = {}, r = 1e3, t = 2, a = "") {
        ...
        let { dec: n = 2, max: s = 1e3, min: o = 1, symbol: l = "" } = e;
        if (o < 0 || s < 0) return `${l}0`;
        let c = this.faker.number.int({
            min: o,
            max: s
        });
        return l + c.toFixed(n);
    }
    productAdjective() {
    ...
    isbn(e = {}) {
        ...
        let { variant: r = 13, separator: t = "-" } = e, a = "978", [n, s] = this.faker.helpers.objectEntry(Dr), o = this.faker.string.numeric(8), l = Number.parseInt(o.slice(0, -1)), c = (A = s.find(([x])=>l <= x)) == null ? void 0 : A[1];
        if (!c) throw new u(`Unable to find a registrant length for the group ${n}`);
        let p = o.slice(0, c), h = o.slice(c), d = [
            a,
            n,
            p,
            h
        ...
        let g = d.join(""), k = 0;
        for(let x = 0; x < r - 1; x++){
            let T = r === 10 ? x + 1 : x % 2 ? 3 : 1;
            k += T * Number.parseInt(g[x]);
        }
        return k = r === 10 ? k % 11 : (10 - k % 10) % 10, d.push(k === 10 ? "X" : k.toString()), d.join(t);
    }
};
var q = class extends b {
    suffixes() {
        return m({
            ...
            ...this.faker.definitions.company.suffix
        ];
    }
    name() {
...
var Rr = {
    ...
    toDigitString: (i)=>i.replace(/[A-Z]/gi, (e)=>{
            var r;
            return String(((r = e.toUpperCase().codePointAt(0)) != null ? r : Number.NaN) - 55);
        })
}, C = Rr;
function vr(i) {
    let e = "";
...
var ee = class extends b {
    ...
    amount(e = {}, r = 1e3, t = 2, a = "", n = !1) {
        ...
        let { autoFormat: s = n, dec: o = t, max: l = r, min: c = 0, symbol: p = a } = e, h = this.faker.number.float({
            max: l,
            min: c,
            fractionDigits: o
        }), d = s ? h.toLocaleString(void 0, {
    ...
    creditCardNumber(e = {}) {
        ...
        if (n in a) t = this.faker.helpers.arrayElement(a[n]);
            ...
            let s = this.faker.helpers.objectValue(a);
            t = this.faker.helpers.arrayElement(s);
        }
    ...
    pin(e = {}) {
        ...
        let { length: r = 4 } = e;
        if (r < 1) throw new u("minimum length is 1");
        return this.faker.string.numeric({
            length: r,
            allowLeadingZeros: !0
        });
    ...
    iban(e = {}, r) {
        ...
        let { countryCode: t = r, formatted: a = !1 } = e, n = t ? C.formats.find((p)=>p.country === t) : this.faker.helpers.arrayElement(C.formats);
        if (!n) throw new u(`Country code ${t} not supported.`);
        let s = "", o = 0;
        for (let p of n.bban){
            let h = p.count;
            for(o += p.count; h > 0;)p.type === "a" ? s += this.faker.helpers.arrayElement(C.alpha) : p.type === "c" ? this.faker.datatype.boolean(.8) ? s += this.faker.number.int(9) : s += this.faker.helpers.arrayElement(C.alpha) : h >= 3 && this.faker.datatype.boolean(.3) ? this.faker.datatype.boolean() ? (s += this.faker.helpers.arrayElement(C.pattern100), h -= 2) : (s += this.faker.helpers.arrayElement(C.pattern10), h--) : s += this.faker.number.int(9), h--;
            s = s.substring(0, o);
        }
        let l = 98 - C.mod97(C.toDigitString(`${s}${n.country}00`));
        l < 10 && (l = `0${l}`);
        let c = `${n.country}${l}${s}`;
        return a ? vr(c) : c;
    }
    bic(e = {}) {
        let { includeBranchCode: r = this.faker.datatype.boolean() } = e, t = this.faker.string.alpha({
            length: 4,
            casing: "upper"
        }), a = this.faker.helpers.arrayElement(C.iso3166), n = this.faker.string.alphanumeric({
            length: 2,
            casing: "upper"
        }), s = r ? this.faker.datatype.boolean() ? this.faker.string.alphanumeric({
            length: 3,
            casing: "upper"
        }) : "XXX" : "";
        return `${t}${a}${n}${s}`;
    ...
    transactionDescription() {
        let e = this.amount(), r = this.faker.company.name(), t = this.transactionType(), a = this.accountNumber(), n = this.maskedNumber(), s = this.currencyCode();
        return `${t} transaction at ${r} using card ending with ***${n} for ${s} ${e} in account ***${a}`;
    }
};
var Lr = "\xA0", re = class extends b {
    branch() {
    ...
    commitEntry(e = {}) {
        ...
        let s = this.faker.person.firstName(), o = this.faker.person.lastName(), l = this.faker.person.fullName({
            firstName: s,
            lastName: o
        }), c = this.faker.internet.userName({
            firstName: s,
            lastName: o
        }), p = this.faker.helpers.arrayElement([
            l,
            c
        ...
        p = p.replace(/^[.,:;"\\']|[<>\n]|[.,:;"\\']$/g, ""), n.push(`Author: ${p} <${h}>`, `Date: ${this.commitDate({
            refDate: a
        })}`, "", `${Lr.repeat(4)}${this.commitMessage()}`, "");
        let d = t === "CRLF" ? `\r
` : `
`;
        return n.join(d);
    ...
    commitDate(e = {}) {
        let { refDate: r = this.faker.defaultRefDate() } = e, t = [
            ...
            days: 1,
            refDate: r
        }), s = t[n.getUTCDay()], o = a[n.getUTCMonth()], l = n.getUTCDate(), c = n.getUTCHours().toString().padStart(2, "0"), p = n.getUTCMinutes().toString().padStart(2, "0"), h = n.getUTCSeconds().toString().padStart(2, "0"), d = n.getUTCFullYear(), g = this.faker.number.int({
            min: -11,
            max: 12
        }), k = Math.abs(g).toString().padStart(2, "0"), A = "00", x = g >= 0 ? "+" : "-";
        return `${s} ${o} ${l} ${c}:${p}:${h} ${d} ${x}${k}${A}`;
    }
    commitSha(e = {}) {
        let { length: r = 40 } = e;
        return this.faker.string.hexadecimal({
...
var ae = class {
    ...
    image(e, r, t, a) {
        return m({
            ...
            since: "8.0",
            until: "9.0"
        }), this.imageUrl(e, r, t, a);
    }
    imageGrayscale(e, r, t) {
        return m({
    ...
    imageBlurred(e, r, t) {
        return m({
            ...
            since: "8.0",
            until: "9.0"
        }), this.imageUrl(e, r, void 0, t);
    }
    imageRandomSeeded(e, r, t, a, n) {
        return m({
            deprecated: "faker.lorempicsum.imageRandomSeeded",
            proposed: "faker.image.urlPicsumPhotos",
            since: "8.0",
            until: "9.0"
        }), this.imageUrl(e, r, t, a, n);
    }
    imageUrl(e, r, t, a, n) {
        m({
        ...
        let s = "https://picsum.photos";
        return n && (s += `/seed/${n}`), s += `/${e}/${r}`, t && a ? `${s}?grayscale&blur=${a}` : t ? `${s}?grayscale` : a ? `${s}?blur=${a}` : s;
    }
};
var ne = class i {
    constructor(e){
        this.faker = e;
        for (let r of Object.getOwnPropertyNames(i.prototype))r === "constructor" || typeof this[r] != "function" || (this[r] = this[r].bind(this));
    }
    imageUrl(e, r, t, a, n, s) {
        m({
        ...
        if (o += `/${e}x${r}`, n != null && (o += `/${n.replace("#", "").toUpperCase()}`, s != null && (o += `/${s.replace("#", "").toUpperCase()}`)), a != null && (o += `.${a}`), t != null) {
    ...
    randomUrl(e, r, t) {
        return m({
            ...
            since: "8.0",
            until: "9.0"
        }), this.imageUrl(e, r, this.faker.lorem.word(), t, this.faker.color.rgb({
            casing: "upper",
            prefix: ""
...
var ie = class {
    ...
    imageUrl(e, r, t, a) {
        ...
        let n = "https://source.unsplash.com";
        return t != null && (n += `/category/${t}`), n += `/${e}x${r}`, a != null && /^([A-Za-z0-9].+,[A-Za-z0-9]+)$|^([A-Za-z0-9]+)$/.test(a) && (n += `?${a}`), n;
    }
    food(e, r, t) {
        return m({
            ...
            since: "8.0",
            until: "9.0"
        }), this.faker.image.unsplash.imageUrl(e, r, "food", t);
    }
    people(e, r, t) {
        return m({
            ...
            since: "8.0",
            until: "9.0"
        }), this.faker.image.unsplash.imageUrl(e, r, "people", t);
    }
    nature(e, r, t) {
        return m({
            ...
            since: "8.0",
            until: "9.0"
        }), this.faker.image.unsplash.imageUrl(e, r, "nature", t);
    }
    technology(e, r, t) {
        return m({
            ...
            since: "8.0",
            until: "9.0"
        }), this.faker.image.unsplash.imageUrl(e, r, "technology", t);
    }
    objects(e, r, t) {
        return m({
            ...
            since: "8.0",
            until: "9.0"
        }), this.faker.image.unsplash.imageUrl(e, r, "objects", t);
    }
    buildings(e, r, t) {
        return m({
            ...
            since: "8.0",
            until: "9.0"
        }), this.faker.image.unsplash.imageUrl(e, r, "buildings", t);
    }
};
var se = class extends b {
    constructor(r){
        ...
        f(this, "lorempicsum");
        f(this, "placeholder");
        this.unsplash = new ie(this.faker), this.lorempicsum = new ae(this.faker), this.placeholder = new ne(this.faker);
    }
    avatar() {
    ...
    url(r = {}) {
        let { width: t = 640, height: a = 480 } = r;
        return this.faker.helpers.arrayElement([
            this.urlLoremFlickr,
    ...
    urlLoremFlickr(r = {}) {
        let { width: t = 640, height: a = 480, category: n } = r;
        return `https://loremflickr.com/${t}/${a}${n == null ? "" : `/${n}`}?lock=${this.faker.number.int()}`;
    }
    urlPicsumPhotos(r = {}) {
        let { width: t = 640, height: a = 480, grayscale: n = !1, blur: s } = r, o = `https://picsum.photos/seed/${this.faker.string.alphanumeric({
            length: {
                min: 5,
                max: 10
            }
        })}/${t}/${a}`, l = typeof s == "number" && s >= 1 && s <= 10;
        return (n || l) && (o += "?", n && (o += "grayscale"), n && l && (o += "&"), l && (o += `blur=${s}`)), o;
    }
    urlPlaceholder(r = {}) {
        let { width: t = this.faker.number.int({
            min: 1,
            max: 3999
        }), height: a = this.faker.number.int({
            min: 1,
            max: 3999
        }), backgroundColor: n = this.faker.color.rgb({
            format: "hex",
            prefix: ""
        }), textColor: s = this.faker.color.rgb({
            format: "hex",
            prefix: ""
            ...
            "png",
            "webp"
        ]), text: l = this.faker.lorem.words() } = r, c = "https://via.placeholder.com";
        return c += `/${t}`, c += `x${a}`, c += `/${n}`, c += `/${s}`, c += `.${o}`, c += `?text=${encodeURIComponent(l)}`, c;
    }
    dataUri(r = {}) {
        let { width: t = 640, height: a = 480, color: n = this.faker.color.rgb(), type: s = "svg-uri" } = r, o = `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" baseProfile="full" width="${t}" height="${a}"><rect width="100%" height="100%" fill="${n}"/><text x="${t / 2}" y="${a / 2}" font-size="20" alignment-baseline="middle" text-anchor="middle" fill="white">${t}x${a}</text></svg>`;
        return s === "svg-uri" ? `data:image/svg+xml;charset=UTF-8,${encodeURIComponent(o)}` : `data:image/svg+xml;base64,${Buffer.from(o).toString("base64")}`;
    }
    image(r, t, a) {
        m({
        ...
        return this[this.faker.helpers.arrayElement(n)](r, t, a);
    }
    imageUrl(r, t, a, n) {
        m({
        ...
        let s = `https://loremflickr.com/${r}/${t}`;
        return a != null && (s += `/${a}`), n && (s += `?lock=${this.faker.number.int()}`), s;
    }
    abstract(r, t, a) {
        return m({
...
function Ke(i) {
    let e = ()=>i.helpers.arrayElement([
        ...
        }, p = i.helpers.objectKey(c), h = i.helpers.arrayElement(c[p]);
        return [
            p,
            h
        ];
    }, t = (c)=>i.helpers.arrayElement({
            lin: [
                "i686",
                "x86_64"
            ],
        ...
        let p = "";
        for(let h = 0; h < c; h++)p += `.${i.string.numeric({
            allowLeadingZeros: !0
        })}`;
        return p;
    }, n = {
        ...
        firefox (c) {
            let p = `${i.number.int({
                min: 5,
                max: 15
            })}${a(2)}`, h = `Gecko/20100101 Firefox/${p}`, d = t(c);
            return `Mozilla/5.0 ${c === "win" ? `(Windows NT ${n.nt()}${d ? `; ${d}` : ""}` : c === "mac" ? `(Macintosh; ${d} Mac OS X ${n.osx()}` : `(X11; Linux ${d}`}; rv:${p.slice(0, -2)}) ${h}`;
        },
        iexplorer () {
            let c = n.ie();
            return c >= 11 ? `Mozilla/5.0 (Windows NT 6.${i.number.int({
                min: 1,
                max: 3
            })}; Trident/7.0; ${i.datatype.boolean() ? "Touch; " : ""}rv:11.0) like Gecko` : `Mozilla/5.0 (compatible; MSIE ${c}.0; Windows NT ${n.nt()}; Trident/${n.trident()}${i.datatype.boolean() ? `; .NET CLR ${n.net()}` : ""})`;
        },
        opera (c) {
            let p = ` Presto/${n.presto()} Version/${n.presto2()})`, h = c === "win" ? `(Windows NT ${n.nt()}; U; ${e()}${p}` : c === "lin" ? `(X11; Linux ${t(c)}; U; ${e()}${p}` : `(Macintosh; Intel Mac OS X ${n.osx()} U; ${e()} Presto/${n.presto()} Version/${n.presto2()})`;
        ...
        safari (c) {
            let p = n.safari(), h = `${i.number.int({
                min: 4,
                max: 7
            })}.${i.number.int(1)}.${i.number.int(10)}`;
            return `Mozilla/5.0 ${c === "mac" ? `(Macintosh; ${t("mac")} Mac OS X ${n.osx("_")} rv:${i.number.int({
                min: 2,
                max: 6
            })}.0; ${e()}) ` : `(Windows; U; Windows NT ${n.nt()})`}AppleWebKit/${p} (KHTML, like Gecko) Version/${h} Safari/${p}`;
        },
        chrome (c) {
            let p = n.safari();
            return `Mozilla/5.0 ${c === "mac" ? `(Macintosh; ${t("mac")} Mac OS X ${n.osx("_")}) ` : c === "win" ? `(Windows; U; Windows NT ${n.nt()})` : `(X11; Linux ${t(c)}`} AppleWebKit/${p} (KHTML, like Gecko) Chrome/${n.chrome()} Safari/${p}`;
        }
    }, [o, l] = r();
    return s[o](l);
}
var oe = class extends b {
    avatar() {
        return m({
            ...
            since: "8.4",
            until: "9.0"
        }), this.faker.image.avatarLegacy();
    }
    email(e = {}, r, t, a) {
        var p;
        (typeof e == "string" || r != null || t != null || a != null) && m({
        ...
        let { firstName: n, lastName: s = r, provider: o = t != null ? t : this.faker.helpers.arrayElement(this.faker.definitions.internet.free_email), allowSpecialCharacters: l = (p = a == null ? void 0 : a.allowSpecialCharacters) != null ? p : !1 } = e, c = this.userName({
            firstName: n,
            lastName: s
        });
        if (c = c.replace(/[^A-Za-z0-9._+-]+/g, ""), c = c.substring(0, 50), l) {
            let h = [
                ..."._-"
            ], d = [
                ...".!#$%&'*+-/=?^_`{|}~"
            ];
            c = c.replace(this.faker.helpers.arrayElement(h), this.faker.helpers.arrayElement(d));
        }
        return c = c.replace(/\.{2,}/g, "."), c = c.replace(/^\./, ""), c = c.replace(/\.$/, ""), `${c}@${o}`;
    }
    exampleEmail(e = {}, r, t) {
        var l;
        (typeof e == "string" || r != null || t != null) && m({
        ...
        let { firstName: a, lastName: n = r, allowSpecialCharacters: s = (l = t == null ? void 0 : t.allowSpecialCharacters) != null ? l : !1 } = e, o = this.faker.helpers.arrayElement(this.faker.definitions.internet.example_email);
        return this.email({
            firstName: a,
            lastName: n,
            provider: o,
            allowSpecialCharacters: s
        });
    }
    userName(e = {}, r) {
        (typeof e == "string" || r != null) && m({
        ...
        let { firstName: t = this.faker.person.firstName(), lastName: a = r != null ? r : this.faker.person.lastName(), lastName: n = r } = e, s, o = this.faker.number.int(n ? 1 : 2), l = this.faker.helpers.arrayElement([
            ".",
            "_"
        ]);
        switch(o){
            case 0:
                s = `${t}${l}${a}${this.faker.number.int(99)}`;
                break;
            case 1:
                s = `${t}${l}${a}`;
                break;
        ...
        return s = s.normalize("NFKD").replace(/[\u0300-\u036F]/g, ""), s = [
            ...
            var h;
            if (we[c]) return we[c];
            let p = (h = c.codePointAt(0)) != null ? h : Number.NaN;
            return p < 128 ? c : p.toString(36);
        }).join(""), s = s.toString().replace(/'/g, ""), s = s.replace(/ /g, ""), s;
    }
    displayName(e = {}, r) {
        (typeof e == "string" || r != null) && m({
        ...
        let { firstName: t = this.faker.person.firstName(), lastName: a = r != null ? r : this.faker.person.lastName() } = e, n;
        switch(this.faker.number.int(2)){
            case 0:
                n = `${t}${this.faker.number.int(99)}`;
                break;
            case 1:
                n = t + this.faker.helpers.arrayElement([
                    ".",
                    "_"
                ]) + a;
                break;
            ...
            default:
                n = `${t}${this.faker.helpers.arrayElement([
                    ".",
                    "_"
                ])}${a}${this.faker.number.int(99)}`;
                break;
        }
        return n = n.toString().replace(/'/g, ""), n = n.replace(/ /g, ""), n;
    }
    protocol() {
        let e = [
            "http",
    ...
    userAgent() {
        return Ke(this.faker);
    }
    color(e = {}, r, t) {
        (typeof e == "number" || t != null || r != null) && m({
        ...
        let { redBase: a = 0, greenBase: n = r != null ? r : 0, blueBase: s = t != null ? t : 0 } = e, o = (h)=>Math.floor((this.faker.number.int(256) + h) / 2).toString(16).padStart(2, "0"), l = o(a), c = o(n), p = o(s);
        return `#${l}${c}${p}`;
    }
    mac(e = {}) {
        typeof e == "string" && (e = {
    ...
    password(e = {}, r, t, a) {
        let n = /[aeiouAEIOU]$/, s = /[bcdfghjklmnpqrstvwxyzBCDFGHJKLMNPQRSTVWXYZ]$/, o = (d, g, k, A)=>{
            if (A.length >= d) return A;
            g && (k = s.test(A) ? n : s);
            let x = this.faker.number.int(94) + 33, T = String.fromCodePoint(x);
            return g && (T = T.toLowerCase()), k.test(T) ? o(d, g, k, A + T) : o(d, g, k, A);
        };
        (typeof e == "string" || r != null || t != null || a != null) && m({
        ...
        let { length: l = 15, memorable: c = r != null ? r : !1, pattern: p = t != null ? t : /\w/, prefix: h = a != null ? a : "" } = e;
        return o(l, c, p, h);
    }
    emoji(e = {}) {
...
var ce = class extends b {
    zipCode(e = {}) {
        ...
        if (r) {
            ...
            if (a) return this.faker.helpers.fake(a);
            throw new u(`No zip code definition found for state "${r}"`);
        }
    ...
    buildingNumber() {
        return this.faker.helpers.arrayElement(this.faker.definitions.location.building_number).replace(/#+/g, (e)=>this.faker.string.numeric({
                length: e.length,
                allowLeadingZeros: !1
            }));
    }
    ...
    secondaryAddress() {
        return this.faker.helpers.arrayElement(this.faker.definitions.location.secondary_address).replace(/#+/g, (e)=>this.faker.string.numeric({
                length: e.length,
                allowLeadingZeros: !1
            }));
    }
    ...
    latitude(e = {}, r = -90, t = 4) {
        ...
        let { max: a = 90, min: n = r, precision: s = t } = e;
        return this.faker.number.float({
            min: n,
            max: a,
            fractionDigits: s
    ...
    longitude(e = {}, r = -180, t = 4) {
        ...
        let { max: a = 180, min: n = r, precision: s = t } = e;
        return this.faker.number.float({
            max: a,
            min: n,
            fractionDigits: s
    ...
    nearbyGPSCoordinate(e = {}, r = 10, t = !1) {
        Array.isArray(e) && (m({
        ...
        let { origin: a, radius: n = r, isMetric: s = t } = e;
        if (a == null) return [
            this.latitude(),
            this.longitude()
        ];
        let o = this.faker.number.float({
            max: 2 * Math.PI,
            fractionDigits: 5
        }), l = s ? n : n * 1.60934, p = this.faker.number.float({
            max: l,
            fractionDigits: 3
        }) * .995, h = 4e4 / 360, d = p / h, g = [
            a[0] + Math.sin(o) * d,
            a[1] + Math.cos(o) * d
        ];
        return g[0] = g[0] % 180, (g[0] < -90 || g[0] > 90) && (g[0] = Math.sign(g[0]) * 180 - g[0], g[1] += 180), g[1] = (g[1] % 360 + 540) % 360 - 180, [
            g[0],
            g[1]
        ];
    }
...
var Ee = {
    ...
    closest: (i, e)=>{
        let r = je(i, (o)=>o.length), t = Object.keys(r).map(Number), a = Math.min(...t), n = Math.max(...t), s = Math.min(e.min - a, n - e.max);
        return i.filter((o)=>o.length === e.min - s || o.length === e.max + s);
    },
    shortest: (i)=>{
...
function N(i) {
    ...
    if (r) {
        let a = typeof r == "number" ? (s)=>s.length === r : (s)=>s.length >= r.min && s.length <= r.max, n = e.filter(a);
        return n.length > 0 ? n : typeof r == "number" ? Ee[t](e, {
            min: r,
            max: r
        }) : Ee[t](e, r);
    } else if (t === "shortest" || t === "longest") return Ee[t](e);
    return [
        ...e
    ];
}
...
var ue = class extends b {
    number(e) {
        return e != null && m({
            ...
            proposed: "faker.phone.number(), faker.string.numeric() or faker.helpers.fromRegExp()",
            since: "8.1",
            until: "9.0"
        }), e = e != null ? e : this.faker.helpers.arrayElement(this.faker.definitions.phone_number.formats), z(this.faker, e);
    }
    imei() {
...
var pe = class extends b {
    word() {
        ...
        do {
            let n = this.faker.helpers.arrayElement(e);
            try {
                t = n();
            } catch  {
                if (a++, a > 100) throw new u("No matching word data available for the current locale");
                continue;
            }
        }while (!t || r.some((n)=>t.includes(n)))
    ...
    locale() {
        throw new u("This method has been removed. Please use `faker.helpers.objectKey(allLocales/allFakers)` instead.");
    }
    alpha(e = {}) {
        return m({
...
var Gr = [
    ...
    fileName(e = {}) {
        let { extensionCount: r = 1 } = e, t = this.faker.word.words().toLowerCase().replace(/\W/g, "_"), a = this.faker.helpers.multiple(()=>this.fileExt(), {
            count: r
        }).join(".");
    ...
    fileType() {
        let e = this.faker.definitions.system.mimeTypes, r = new Set(Object.keys(e).map((t)=>t.split("/")[0]));
        return this.faker.helpers.arrayElement([
            ...r
        ]);
    }
    ...
    networkInterface(e = {}) {
        var o, l, c, p, h;
        let { interfaceType: r = this.faker.helpers.arrayElement(Or), interfaceSchema: t = this.faker.helpers.objectKey(ze) } = e, a, n = "", s = ()=>this.faker.string.numeric({
                allowLeadingZeros: !0
            });
        switch(t){
            case "index":
                ...
                break;
            case "slot":
                a = `${s()}${(o = this.faker.helpers.maybe(()=>`f${s()}`)) != null ? o : ""}${(l = this.faker.helpers.maybe(()=>`d${s()}`)) != null ? l : ""}`;
                break;
            case "mac":
                a = this.faker.internet.mac("");
                break;
            case "pci":
                n = (c = this.faker.helpers.maybe(()=>`P${s()}`)) != null ? c : "", a = `${s()}s${s()}${(p = this.faker.helpers.maybe(()=>`f${s()}`)) != null ? p : ""}${(h = this.faker.helpers.maybe(()=>`d${s()}`)) != null ? h : ""}`;
                break;
        }
        return `${n}${r}${ze[t]}${a}`;
    }
    cron(e = {}) {
        let { includeYear: r = !1, includeNonStandard: t = !1 } = e, a = [
            ...
            this.faker.helpers.arrayElement(Kr),
            "*",
            "?"
        ], c = [
            this.faker.number.int({
            ...
            "*"
        ], p = this.faker.helpers.arrayElement(a), h = this.faker.helpers.arrayElement(n), d = this.faker.helpers.arrayElement(s), g = this.faker.helpers.arrayElement(o), k = this.faker.helpers.arrayElement(l), A = this.faker.helpers.arrayElement(c), x = `${p} ${h} ${d} ${g} ${k}`;
        r && (x += ` ${A}`);
        let T = [
            "@annually",
            "@daily",
        ...
        return !t || this.faker.datatype.boolean() ? x : this.faker.helpers.arrayElement(T);
    }
};
...
var Ve = class extends F {
    constructor(r){
        ...
        f(this, "rawDefinitions");
        f(this, "definitions");
        f(this, "random", new pe(this));
        f(this, "airline", new _(this));
        f(this, "animal", new J(this));
        f(this, "color", new G(this));
        f(this, "commerce", new X(this));
        f(this, "company", new q(this));
        f(this, "database", new Q(this));
        f(this, "date", new j(this));
        f(this, "finance", new ee(this));
        f(this, "git", new re(this));
        f(this, "hacker", new te(this));
        f(this, "helpers", new V(this));
        f(this, "image", new se(this));
        f(this, "internet", new oe(this));
        f(this, "location", new ce(this));
        f(this, "lorem", new le(this));
        f(this, "music", new me(this));
        f(this, "person", new O(this));
        f(this, "phone", new ue(this));
        f(this, "science", new he(this));
        f(this, "system", new fe(this));
        f(this, "vehicle", new be(this));
        f(this, "word", new de(this));
        let { locales: t } = r;
        if (t != null) {
            m({
            ...
            let { locale: n = "en", localeFallback: s = "en" } = r;
            r = {
                locale: [
                    t[n],
                    t[s]
        ...
        let { locale: a } = r;
        if (Array.isArray(a)) {
            if (a.length === 0) throw new u("The locale option must contain at least one locale definition.");
            a = Oe(a);
        }
        this.rawDefinitions = a, this.definitions = Le(this.rawDefinitions);
    }
    get address() {
        return m({
    ...
    getMetadata() {
        var r;
        return (r = this.rawDefinitions.metadata) != null ? r : {};
    }
    get locales() {
        throw new u("The locales property has been removed. Please use the constructor instead.");
    }
    set locales(r) {
        throw new u("The locales property has been removed. Please use the constructor instead.");
    }
    get locale() {
        throw new u("The locale property has been removed. Please use the constructor instead.");
    }
    set locale(r) {
        throw new u("The locale property has been removed. Please use the constructor instead.");
    }
    get localeFallback() {
        throw new u("The localeFallback property has been removed. Please use the constructor instead.");
    }
    set localeFallback(r) {
        throw new u("The localeFallback property has been removed. Please use the constructor instead.");
    }
    setLocale() {
        throw new u("This method has been removed. Please use the constructor instead.");
    }
};
var He = [
    "CIE 1931 XYZ",
...
"[project]/unexpected/node_modules/@faker-js/faker/dist/esm/chunk-3LPAMF3R.mjs [app-rsc] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
;
;
var f = new __TURBOPACK__imported__module__$5b$project$5d2f$unexpected$2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$esm$2f$chunk$2d$GTEBSQTL$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["j"]({
    locale: [
...
"[project]/unexpected/node_modules/@faker-js/faker/dist/esm/chunk-3LPAMF3R.mjs [app-rsc] (ecmascript) <export a as faker>": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";

__turbopack_esm__({
    "faker": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$unexpected$2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$esm$2f$chunk$2d$3LPAMF3R$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["a"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$unexpected$2f$node_modules$2f40$faker$2d$js$2f$faker$2f$dist$2f$esm$2f$chunk$2d$3LPAMF3R$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/unexpected/node_modules/@faker-js/faker/dist/esm/chunk-3LPAMF3R.mjs [app-rsc] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
...
"[project]/unexpected/node_modules/hugeicons-react/dist/esm/icons/keyframes_multiple_icon.js [app-rsc] (ecmascript)": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";
...
"__TURBOPACK__ecmascript__hoisting__location__";
;
const o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$unexpected$2f$node_modules$2f$hugeicons$2d$react$2f$dist$2f$esm$2f$create$2d$hugeicon$2d$component$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"])("KeyframesMultipleIcon", [
    [
        "path",
        {
...
"[project]/unexpected/node_modules/hugeicons-react/dist/esm/icons/keyframes_multiple_icon.js [app-rsc] (ecmascript) <export default as KeyframesMultipleIcon>": (({ r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__ }) => (() => {
"use strict";

__turbopack_esm__({
    "KeyframesMultipleIcon": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$unexpected$2f$node_modules$2f$hugeicons$2d$react$2f$dist$2f$esm$2f$icons$2f$keyframes_multiple_icon$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"]
});
var __TURBOPACK__imported__module__$5b$project$5d2f$unexpected$2f$node_modules$2f$hugeicons$2d$react$2f$dist$2f$esm$2f$icons$2f$keyframes_multiple_icon$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/unexpected/node_modules/hugeicons-react/dist/esm/icons/keyframes_multiple_icon.js [app-rsc] (ecmascript)");
"__TURBOPACK__ecmascript__hoisting__location__";
...
//# sourceMappingURL=node_modules_1b0d9b._.js.map